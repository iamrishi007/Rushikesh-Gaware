...
export default function Hero() {
  const words = [
    ...
    "Exploring AI Integration & Modern Web Solutions",
    "Building Scalable & User-Friendly Applications",
    "Passionate About Clean Code & UI/UX",
    "Always Learning, Growing & Innovating ...!"
  ];


  const [code] = useState(`
const profile = {
    name: 'Rushikesh Gaware',
  ...
  'Git', 'GitHub',
  'AI API Integration (Generative AI, NLP)'
]
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 mb-6 sm:mb-8 animate__animated animate__fadeInDown animate__delay-1s">
                ...
                <span className="text-gray-300 text-xs sm:text-sm font-medium">
                  Welcome to my innovation space !
                </span>
              </div>
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Full Stack Developer | MERN & AI Explorer | Creating Modern User-Focused Applications 🤖✨
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/iamrishi007"
                ...
                >
<a href="/src/assets/Resume 2.pdf" target="_blank" rel="noopener noreferrer">
              ...
              <div className="hidden lg:block absolute left-[5.5rem] top-[2.3rem] animate-float-slow">
                <div className="px-4 py-2 rounded-lg bg-purple-500/10 backdrop-blur-sm border border-purple-500/20 text-purple-400">
                  <i className="fas fa-wand-magic-sparkles"></i>&nbsp;&nbsp;Crafting Intuitive Interfaces
                </div>
              </div>
